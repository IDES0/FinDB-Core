...
# gcp:
# app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+pg8000://postgres:@172.17.0.1:5432/postgres' 
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://postgres:db123@172.17.0.1:5432/postgres'
db = SQLAlchemy(app)
